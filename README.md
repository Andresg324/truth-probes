...
Code, data, and regenerable results for the paper *What Deception Probes Read and How Evaluations of Them Fail* (Andres Garcia, 2026). arXiv and DOI links will be added on release.
...
- Answer polarity survives all 43 ablation conditions (AUC 1.00 throughout), and clean-patching restores 94-98% of what ablation removes.
